           ...
           return(
             ...
             <div className={styles.countryItem}>
               ...
               <div className={styles.countryInfo}>
                 <span className={styles.textInfo}> Confirmed <span className={styles.numberInfo}> {country.TotalConfirmed}</span></span>
                 <span className={styles.textInfo}> Deaths <span className={styles.numberInfo}> {country.TotalDeaths}</span></span>
                 <span className={styles.textInfo}> Recovered <span className={styles.numberInfo}> {country.TotalRecovered}</span></span>
               </div>
             </div>
             </a></Link>
           )
